...
| **Per-sprint review / Architect handoff**     | [`docs/tracker/REVIEW_HISTORY.md`](../docs/tracker/REVIEW_HISTORY.md) · scenarios [`docs/testing/`](../docs/testing/README.md) · templates [`docs/templates/`](../docs/templates/README.md) |
