...
const schemas: Record<string, z.ZodType> = {
  ...
  // P-2 — camera lifecycle, identity, operational health, capability cache, stream probe.
  'camera-lifecycle': CameraLifecycle,
  'camera-timeline-entry': CameraTimelineEntry,
  'camera-device-identity': CameraDeviceIdentity,
  'camera-operational-health': CameraOperationalHealth,
  'camera-health-summary': CameraHealthSummary,
  'capability-cache': CapabilityCache,
  'capability-refresh-result': CapabilityRefreshResult,
  ...
  // P-2.2 — immutable probe evidence, replay, drift, operational confidence.
  'camera-probe-record': CameraProbeRecord,
  'camera-probe-history': CameraProbeHistory,
  'probe-replay': ProbeReplay,
  'camera-probe-metrics': CameraProbeMetrics,
