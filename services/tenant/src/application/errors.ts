/**
 * Application errors carrying an HTTP status + stable code. The transport error-handler
 * renders these into the public `ApiError` envelope. 4xx messages are safe to surface.
 */
