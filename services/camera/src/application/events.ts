/**
 * Domain-event publisher seam. P1-3 needs to *announce* camera lifecycle changes
 * (`camera.registered|updated|removed`, `camera.health.changed`) so `media` (P1-4) can react,
