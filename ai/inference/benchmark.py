...
def run_benchmark(
    ...
    *,
    ...
    for cam in range(workload.cameras):
        ...
        # Genuine drop tracking (backpressure/failure) is an AI-5c concern; the offline pipeline loses
        # nothing, so dropped stays 0 here unless a real loss signal is surfaced later.
        run.dropped += 0
