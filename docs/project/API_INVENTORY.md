...
| GET    | `/rules/:id/dependencies`         | What this rule points at (P-4.1)             | `rule:read`   | —                     | `200 {success,data:RuleDependencyGraph}` · `404`                                     | Mongo, @vip/tenancy             | beta     | 0.1.0   |
...
| POST   | `/rules/import`                   | Import a package — **always as drafts**      | `rule:create` | `RulePackage`         | `200 {success,data:RuleImportResult}` · `400/403`                                    | Mongo, @vip/tenancy             | beta     | 0.1.0   |
