...
|                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Current behaviour** | There is no per-camera AI assignment: no profile, no model selection, no priority, no cost estimate, no last-inference time, no inference health — none of these exists in any contract, route or store. ⚠️ Measured at P-6.6: the deployed media service uses a **null frame sink** and no frame-sink is configured anywhere, so **every frame is discarded and no camera is analysed**                                                                                                                                |
