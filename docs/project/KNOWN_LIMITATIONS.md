...
| **Planned**           | **P-8**, whose stated dependency is exactly this frame path (TD-4/TD-5). It needs an assignment contract, a store, an enforcement point in the pipeline and a cost model. ⚠️ Building the UI first would be a control that configures nothing                                                                                                                                            |
