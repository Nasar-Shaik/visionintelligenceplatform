...
- **Next step:** **P2-1.10 Incidents** (timeline + ack/resolve/close) → **P2-1.11 Alerts** (delivery history + ack) — the remaining enabler-free slices. The flagship **Cameras/Live/Analysis/Evidence** slices wait on enablers **G-1…G-6** (OPERATIONS_CONSOLE §13).
