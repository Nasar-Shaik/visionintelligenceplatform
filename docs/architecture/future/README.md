...
| 14  | Future AI Processing Pipeline                | [AI_PROCESSING_PIPELINE](AI_PROCESSING_PIPELINE.md) _(superseded by #15)_                         | [05](../05-CAPABILITY-ARCHITECTURE.md), [08](../08-AI-ML-PLATFORM.md)                                | ADR-0002/0012        |
| 15  | **AI Execution Architecture** (canonical)    | **[AI_EXECUTION_ARCHITECTURE](AI_EXECUTION_ARCHITECTURE.md)**                                     | [05](../05-CAPABILITY-ARCHITECTURE.md), [08](../08-AI-ML-PLATFORM.md), [09](../09-EVENT-PLATFORM.md) | ADR-0002/0012        |
| 16  | **Selective AI Processing** (P-8, 🔒 frozen) | **[SELECTIVE_AI_PROCESSING](SELECTIVE_AI_PROCESSING.md)**                                         | #15, [PLATFORM_BOUNDARIES](../PLATFORM_BOUNDARIES.md), AI Runtime v1.0 (frozen)                      | ADR-A/B ratified     |
...
>
> **Row 16 is the P-8 planning pass (2026-08-05), commissioned at the P-6.6 approval:** the design of
> the one layer #15 does not have — the **binding between a camera and processing**, which is what
> makes "record 16, analyse 2" expressible. ⚠️ It opens by recording what was found in the tree before
> designing: the scheduler, the cost model and the profile formats **already exist** in the frozen AI
> Runtime, the behaviour analyzers are built, and the runtime **has never been deployed**. Design
> only — nothing implemented, two ADRs named and unwritten.
>
> **Row 15 is the AI Processing Phase kickoff (2026-07-31, [ED-0036](../../project/ENGINEERING_DECISION_LOG.md)):** the **canonical reference architecture** for all AI video-intelligence work, commissioned by the Architect after G-5. It **consolidates and supersedes row 14** (one reference, not three overlapping notes), folds in the six AI-phase recommendations, and defines the incremental milestones **AI-1…AI-4**. **Cite #15 going forward.**
