...
3. **Deploy-anywhere with identical semantics.** One codebase runs cloud, on-prem, hybrid, and fully offline edge; deployment mode is configuration and capability *placement*, not a fork.
