...
- Update: [`tracking/PROGRESS.md`](../../tracking/PROGRESS.md), [`tracking/TASK-BOARD.md`](../../tracking/TASK-BOARD.md), [`docs/project/*`](../project/), and append a **daily log** ([`docs/tracker/DAILY_LOG.md`](../tracker/DAILY_LOG.md)).
