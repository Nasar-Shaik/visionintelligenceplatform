...
2. **On approval → P1-1** — tenant foundation + fail-closed isolation guard (contract-first; [TENANT_ARCHITECTURE](../architecture/phase1/TENANT_ARCHITECTURE.md); [R-010](../project/RISK_REGISTER.md)), following [ROADMAP](../architecture/phase1/ROADMAP.md).
